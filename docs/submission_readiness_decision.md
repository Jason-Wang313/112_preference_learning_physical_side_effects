...
Honest strongest claim: `Learn preferences over physical side effects that are absent from task success labels.` is a plausible branch-structured mechanism for human preference learning for robots, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
