...
\usepackage{url}
\usepackage{booktabs}
\title{Preference Learning Physical Side Effects: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about human preference learning for robots. The original research bet was: Learn preferences over physical side effects that are absent from task success labels. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item APRICOT: Active Preference Learning and Constraint-Aware Task Planning with LLMs (2024)
\item Unified Learning from Demonstrations, Corrections, and Preferences during Physical Human-Robot Interaction (2024)
\item DriveLLaVA: Human-Level Behavior Decisions via Vision Language Model (2024)
\item Preference-Based Assistance Prediction for Human-Robot Collaboration Tasks (2018)
\item Are physically embodied social agents better than disembodied social agents?: The effects of physical embodiment, tactile interaction, and people's loneliness in human-robot interaction (2006)
\end{itemize}
